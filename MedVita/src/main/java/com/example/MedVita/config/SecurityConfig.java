...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager userDetailsService() {
        ...
        UserDetails medico = User.builder()
                .username(userConfig.getMedicoUsername())
                .password(passwordEncoder().encode(userConfig.getMedicoPassword()))
                .roles("MEDICO")
                .build();

        return new InMemoryUserDetailsManager(user, admin, medico);
    }
