...
public class SecureLoginController {
        ...
        public String medico(
                ...
                System.out.println(
                                "Médico logado: " + authentication.getName());
        ...
        public String pacienteConsultas() {
                return "paciente/consultas";
        }

        @GetMapping("/paciente/agendar-consulta")
        public String pacienteAgendarConsulta() {
                return "paciente/agendar-consulta";
        }

        @GetMapping("/paciente/internacoes")
        public String pacienteInternacoes() {
                return "paciente/internacoes";
        }
        ...
        public String medicoConsultas() {
                return "medico/consultas";
        }

        @GetMapping("/medico/internacoes")
        public String medicoInternacoes() {
                return "medico/internacoes";
        }

        @GetMapping("/medico/quartos")
        public String medicoQuartos() {
                return "medico/quartos";
        }
